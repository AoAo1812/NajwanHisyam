 export default function learnpage() {
    ...
    <div className=" bg-white h-screen flex gap-4 justify-center items-center p-6/" >
        ...
        <div className=" bg-blue-200 h-65 w-96 flex flex-col justify-between p-12 rounded-4xl text-black"> 
            ...
            <div className=" bg-green-200 h-65 w-96 flex flex-col justify-between p-12 rounded-4xl text-black"> 
